          ...
          },
          {
            ...
            items: [
              { label: '아키텍처 의사결정 기록', slug: 'adr' },
              {
                label: '기초 설계',
                items: [
                  { slug: 'adr/0002-use-fin-over-exceptions' },
                  { slug: 'adr/0003-languageext-as-functional-foundation' },
                ],
              },
              {
                label: '도메인 레이어',
                items: [
                  { slug: 'adr/0004-cqrs-read-write-separation' },
                  { slug: 'adr/0008-ulid-based-entity-id' },
                  { slug: 'adr/0015-union-valueoject-state-machine' },
                  { slug: 'adr/0017-specification-pattern-expression-tree' },
                  { slug: 'adr/0020-aggregate-id-only-cross-references' },
                  { slug: 'adr/0021-domain-service-pure-vs-repository' },
                  { slug: 'adr/0022-value-object-class-record-duality' },
                  { slug: 'adr/0023-error-code-sealed-record-hierarchy' },
                ],
              },
              {
                label: '애플리케이션 레이어',
                items: [
                  { slug: 'adr/0005-pipeline-execution-order' },
                  { slug: 'adr/0012-finresponse-pipeline-type-constraints' },
                  { slug: 'adr/0014-validation-normalize-then-maxlength' },
                  { slug: 'adr/0018-explicit-transaction-support' },
                ],
              },
              {
                label: '어댑터 레이어',
                items: [
                  { slug: 'adr/0006-observable-port-source-generator' },
                  { slug: 'adr/0010-suffix-naming-for-persistence' },
                ],
              },
              {
                label: '관측성',
                items: [
                  { slug: 'adr/0007-ctx-enricher-pillar-targeting' },
                  { slug: 'adr/0009-error-classification-three-types' },
                  { slug: 'adr/0016-observability-field-naming-snake-case-dot' },
                ],
              },
              {
                label: '도메인 이벤트',
                items: [
                  { slug: 'adr/0013-domain-event-publisher-simplification' },
                  { slug: 'adr/0019-domain-event-tracing-correlation' },
                ],
              },
              {
                label: '아키텍처 테스트',
                items: [
                  { slug: 'adr/0011-architecture-test-suite-framework' },
                ],
              },
            ],
          },
