...
| 타입 | 네임스페이스 | 설명 |
|------|-------------|------|
| `IObservablePort` | `Functorium.Domains.Observabilities` | 모든 Port/Adapter의 기반 인터페이스 (관측성 카테고리 제공) |
...
| `OptionsConfigurator` | `Functorium.Adapters.Options` | FluentValidation 기반 옵션 유효성 검사 등록 |
