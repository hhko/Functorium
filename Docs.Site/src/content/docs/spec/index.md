...
| [에러 시스템](./04-error-system) | `DomainErrorType`, `ApplicationErrorType`, `AdapterErrorType`, 팩토리 API |
...
| [도메인 이벤트](./09-domain-events) | `DomainEvent`, Publisher/Collector, Handler, Log Enricher |
...
| [소스 생성기](./10-source-generators) | 5개 소스 생성기 사양 (EntityId, ObservablePort, LogEnricher, UnionType) |
