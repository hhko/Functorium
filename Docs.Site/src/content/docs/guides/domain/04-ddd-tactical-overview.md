...
|------|----------|
| Value Object | `Tests.Hosts/01-SingleHost/LayeredArch.Domain/ValueObjects/` |
...
### Value Object's Create() Always Fails
...
### Unsure Where to Place Domain Logic
...
- [Ardalis.SmartEnum](https://github.com/ardalis/SmartEnum) - Type-safe enumerations
