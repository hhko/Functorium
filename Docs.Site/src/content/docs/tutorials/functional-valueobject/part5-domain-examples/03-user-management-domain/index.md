...
다양한 입력 형식(010-1234-5678, +82-10-1234-5678 등)을 정규화된 국제 형식으로 저장하고, `Formatted`로 표시용 형식을 provides. 입력 형식과 저장 형식의 분리 패턴입니다.
...
각 value object의 속성, 검증 규칙, 보안 기능을 한눈에 비교할 수 있습니다.

| value object | 주요 속성 | 검증 규칙 | 보안 기능 |
|--------|----------|----------|----------|
