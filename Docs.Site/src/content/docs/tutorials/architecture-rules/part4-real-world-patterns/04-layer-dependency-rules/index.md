...
The following table 3-레이어 아키텍처의 의존성 규칙을 요약합니다.
...
The following table 각 검증 유형별 사용 도구를 정리합니다.
...
Next chapter에서는 `DomainArchitectureTestSuite`와 `ApplicationArchitectureTestSuite`를 상속하여 검증된 규칙을 즉시 적용하는 방법을 학습합니다.
