...
> **실제 프로젝트에서는** Functorium이 제공하는 `EfCoreRepositoryBase`, `DapperQueryBase`, `InMemoryQueryBase` 어댑터 베이스 클래스를 사용합니다. 이 클래스들은 위 `BuildQuery` 패턴을 이미 내장하고 있습니다. 자세한 내용은 [CQRS Repository 튜토리얼](../../cqrs-repository/)을 참고하세요.
...
→ [Part 4의 1장: Usecase 패턴](../../Part4-Real-World-Patterns/01-Usecase-Patterns/)
