...
Specification 패턴만이 비즈니스 규칙을 관리하는 유일한 방법은 아닙니다. 람다 식을 직접 전달하거나, Query Object 패턴을 사용하거나, LINQ 확장 메서드를 조합하는 방법도 있습니다. 그렇다면 언제 Specification을 선택해야 할까요? 이 부록에서는 주요 대안들과 Specification 패턴을 비교하여 각각의 적합한 사용 시나리오를 정리합니다.

---

## 접근법 비교

다섯 가지 접근법의 장단점과 적합한 상황을 한눈에 비교합니다.
