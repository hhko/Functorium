...
Aggregate Root로 일관성 경계를 보호하는 방법을 배웠습니다. 그런데 주문이 확인되면 결제 시스템과 재고 시스템에 어떻게 알릴까요? Aggregate가 직접 호출하면 강한 결합이 생깁니다. 다음 장에서는 도메인 이벤트를 통해 시스템 간 느슨한 결합을 만드는 방법을 살펴봅니다.

→ [3장: 도메인 이벤트](../03-Domain-Events/)
