# Entity/Aggregate 구현 (HOW)

이 문서는 Functorium 프레임워크로 Entity와 Aggregate를 구현하는 방법을 다룹니다. 설계 원칙과 개념은 [06a-aggregate-design.md](./06a-aggregate-design.md)를 참조하세요.
...
6. 필요 시 부가 인터페이스 적용 (`IAuditable`, `ISoftDeletable`, `IConcurrencyAware`)
