...
통합 테스트 작성 시 기본적인 테스트 명명 규칙, 변수 명명 규칙, AAA 패턴 등은 [단위 테스트 가이드](./15-unit-testing.md)를 준수합니다.

| 규칙 | 참조 |
|------|------|
| 테스트 명명 (T1_T2_T3) | [테스트 명명 규칙](./15-unit-testing.md#테스트-명명-규칙) |
| 변수 명명 (`sut`, `actual` 등) | [변수 명명 규칙](./15-unit-testing.md#변수-명명-규칙) |
| AAA 패턴 | [AAA 패턴](./15-unit-testing.md#aaa-패턴) |
...
- [단위 테스트 가이드](./15-unit-testing.md) - 테스트 명명 규칙, AAA 패턴 등 기본 테스트 작성 규칙
