...
- [요약](#요약)
- [왜 도메인 서비스인가](#왜-도메인-서비스인가)
- [도메인 서비스란 무엇인가 (WHAT)](#도메인-서비스란-무엇인가-what)
- [도메인 서비스 구현 (HOW)](#도메인-서비스-구현-how)
...
**아키텍처 테스트 가능**:
`IDomainService` 마커 인터페이스로 아키텍처 규칙을 검증할 수 있습니다 (예: Domain Service가 [IObservablePort](./12-ports.md)를 의존하지 않는지).
...
- [08b-error-system-domain-app.md](./08b-error-system-domain-app.md) - DomainError 정의 및 테스트 패턴
...
- [15a-unit-testing.md](./15a-unit-testing.md) - 단위 테스트 규칙 (T1_T2_T3, AAA 패턴)
