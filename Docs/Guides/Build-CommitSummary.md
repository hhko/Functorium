...
## feat (New features) - 5건

- `abc1234` **작성자        ** feat(auth): 로그인 기능 추가
- `def5678` **작성자        ** feat: 회원가입 구현

## fix (Bug fixes) - 3건

- `ghi9012` **작성자        ** fix: 로그인 오류 수정
...
```
...
| `other` | Non-conventional commits | 규격 외 커밋 |
...
- [Git 명령어 가이드](./Git-Commands.md) - Git 범위 표현식
- [Git 커밋 가이드](./Git-Commit.md) - Conventional Commits 규격
- [Git 기반 버전 관리 가이드](./Build-Versioning.md) - 태그 기반 버전 관리
