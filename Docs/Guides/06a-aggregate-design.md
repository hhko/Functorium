...
이 문서는 DDD 전술적 설계 관점에서 Aggregate 설계 원칙과 개념을 다룹니다. Entity/Aggregate 구현 방법은 [06b-entity-aggregate-implementation.md](./06b-entity-aggregate-implementation.md)를 참조하세요.
