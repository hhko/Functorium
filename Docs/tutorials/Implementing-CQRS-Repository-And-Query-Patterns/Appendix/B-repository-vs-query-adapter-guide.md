# 부록 B. Repository vs Query 어댑터 선택 가이드

> **부록** | [<- 이전: A. CQRS vs 전통적 CRUD](A-cqrs-vs-crud.md) | [목차](../README.md) | [다음: C. FinT / FinResponse 타입 참조 ->](C-fint-finresponse-reference.md)
...
Specification 패턴의 상세 학습은 [Specification 패턴으로 도메인 규칙 구현하기](../../Implementing-Specification-Pattern/README.md)를 참조하세요.
