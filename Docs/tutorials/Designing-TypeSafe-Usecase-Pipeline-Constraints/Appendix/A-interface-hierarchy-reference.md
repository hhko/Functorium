...
[← 이전: 20장 Pipeline 전체 흐름 통합](../Part5-Practical-Usecase-Examples/03-Full-Pipeline-Integration/README.md) | [다음: B. Pipeline 제약 조건 vs 대안 비교 →](B-constraint-vs-alternatives.md)
