# 11장: IFinResponseFactory CRTP 팩토리
...
[← 이전: 10장 IFinResponse<out A> 공변 인터페이스](../02-IFinResponse-Covariant/README.md) | [다음: 12장 IFinResponseWithError 에러 접근 →](../04-IFinResponseWithError/README.md)
