# 12장: IFinResponseWithError 에러 접근
...
[← 이전: 11장 IFinResponseFactory CRTP 팩토리](../03-IFinResponseFactory-CRTP/README.md) | [다음: 13장 FinResponse<A> Discriminated Union →](../05-FinResponse-Discriminated-Union/README.md)
