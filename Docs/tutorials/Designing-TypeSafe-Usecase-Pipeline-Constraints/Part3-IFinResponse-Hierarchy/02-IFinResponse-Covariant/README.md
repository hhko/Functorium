# 10장: IFinResponse<out A> 공변 인터페이스
...
[← 이전: 9장 IFinResponse 비제네릭 마커](../01-IFinResponse-Marker/README.md) | [다음: 11장 IFinResponseFactory CRTP 팩토리 →](../03-IFinResponseFactory-CRTP/README.md)
