...
using ValidationFluent.ValueObjects.Comparable.PrimitiveValueObjects;
using ValidationFluent.ValueObjects.ComparableNot.PrimitiveValueObjects;
using ValidationFluent.ValueObjects.Comparable.CompositePrimitiveValueObjects;
using ValidationFluent.ValueObjects.ComparableNot.CompositePrimitiveValueObjects;

namespace ValidationFluent;

class Program
{
    static void Main()
    {
        Console.WriteLine("=== Validate<T> Fluent API를 사용한 간결한 검증 패턴 ===\n");
    ...
    static string PrintError(Error error) => error.Message;
