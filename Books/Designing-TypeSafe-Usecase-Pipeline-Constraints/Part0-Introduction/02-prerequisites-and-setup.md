...
이 책을 학습하기 위해 다음 개념을 알고 있어야 합니다:
...
cd Books/Designing-TypeSafe-Usecase-Pipeline-Constraints/Part1-Generic-Variance-Foundations/01-Covariance/Covariance
dotnet build
