# 5장: Mediator Pipeline Behavior 구조
...
[← 이전: 4장 인터페이스 분리와 변성 조합](../../Part1-Generic-Variance-Foundations/04-Interface-Segregation-And-Variance/README.md) | [다음: 6장 Fin<T> 직접 사용의 한계 →](../02-Fin-Direct-Limitation/README.md)
