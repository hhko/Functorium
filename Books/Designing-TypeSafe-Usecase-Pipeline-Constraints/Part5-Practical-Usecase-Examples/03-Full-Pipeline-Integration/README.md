...
[← 이전: 19장 Query Usecase 완전 예제](../02-Query-Usecase-Example/README.md) | [다음: 부록 A. IFinResponse 인터페이스 계층 전체 참조 →](../../Appendix/A-interface-hierarchy-reference.md)
