...
```csharp
// 속성 정의
namespace Functorium.SourceGenerator;

public class GeneratePipelineAttribute : System.Attribute { }

// 메타데이터 이름
"Functorium.SourceGenerator.GeneratePipelineAttribute"
        ...
        AttachDebugger: false)
{
    ...
    private const string AttributeNamespace = "Functorium.SourceGenerator";
