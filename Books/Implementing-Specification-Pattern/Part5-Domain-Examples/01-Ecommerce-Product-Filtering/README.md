# Part 5 - Chapter 17: 전자상거래 상품 필터링

> **Part 5: 도메인 예제** | [← 목차로](../../README.md)

---

## 개요

실제 전자상거래 도메인에서 Specification 패턴을 활용하여 상품 필터링을 구현합니다. Value Object를 사용한 도메인 모델링과 ExpressionSpecification 기반의 다양한 필터링 조건을 조합하는 방법을 학습합니다.
