...
> **Part 1: 값 객체 개념 이해** | [← 이전: 7장 값 기반 동등성](../../07-Value-Equality/ValueEquality/README.md) | [목차](../../../README.md) | [다음: 9장 생성/검증 분리 →](../../09-Create-Validate-Separation/CreateValidateSeparation/README.md)
