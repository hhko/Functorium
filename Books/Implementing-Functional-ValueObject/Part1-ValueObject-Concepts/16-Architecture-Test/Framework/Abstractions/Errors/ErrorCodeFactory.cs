...
public static class ErrorCodeFactory
{
    ...
    public static Error Create<T>(string errorCode,
                                  T errorCurrentValue) where T : notnull =>
    ...
    public static Error Create<T1, T2>(string errorCode,
                                       ...
                                       T2 errorCurrentValue2) where T1 : notnull where T2 : notnull =>
    ...
    public static Error Create<T1, T2, T3>(string errorCode,
                                           ...
                                           T3 errorCurrentValue3) where T1 : notnull where T2 : notnull where T3 : notnull =>
