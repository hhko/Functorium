...
using ErrorCodeFluent.ValueObjects.ComparableNot.PrimitiveValueObjects;
using ErrorCodeFluent.ValueObjects.Comparable.CompositePrimitiveValueObjects;
using ErrorCodeFluent.ValueObjects.ComparableNot.CompositePrimitiveValueObjects;

namespace ErrorCodeFluent;

class Program
{
    static void Main()
    {
        Console.WriteLine("=== DomainError 헬퍼를 사용한 간결한 에러 처리 패턴 ===\n");
