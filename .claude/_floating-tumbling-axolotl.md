...
| # | 파일 | 변경 |
|---|------|------|
| 1 | `Docs/guides/03-entities-and-aggregates.md` | §8에 팩토리 패턴 상세 내용 통합 (Apply, Port 조율, 사례, EFCore, 가이드라인) |
| 2 | `Docs/guides/ddd-tactical-improvements.md` | §8을 참조 링크로 축소 |
| 3 | `Docs/guides/README.md` | 팩토리 패턴 참조 경로 업데이트 |
