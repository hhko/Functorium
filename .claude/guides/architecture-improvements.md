...
- ArchUnit 테스트 규칙과 연계 (현재 [13-testing-library.md](./13-testing-library.md)에 아키텍처 규칙 검증 존재)
- 위반 시나리오 예시 추가
...
- [11-ports-and-adapters.md](./11-ports-and-adapters.md) — Port와 Adapter
...
- [13-testing-library.md](./13-testing-library.md) — 테스트 라이브러리 (아키텍처 규칙 검증)
