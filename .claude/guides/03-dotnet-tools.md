...
- [개요](#개요)
- [§1. CLI 도구 (.config/dotnet-tools.json)](#1-cli-도구-configdotnet-toolsjson)
- [§2. 소스 생성기](#2-소스-생성기)
- [§3. .NET 10 파일 기반 프로그램](#3-net-10-파일-기반-프로그램)
- [§4. 도구 전체 맵](#4-도구-전체-맵)
- [§5. 새 도구 추가 체크리스트](#5-새-도구-추가-체크리스트)
- [§6. 트러블슈팅](#6-트러블슈팅)
- [참고 문서](#참고-문서)
...
| 소스 생성기 | 컴파일 시 코드 자동 생성 | EntityIdGenerator, AdapterPipelineGenerator |
...
## §1. CLI 도구 (.config/dotnet-tools.json)
...
| `AdapterPipelineGenerator` | `[GeneratePipeline]` | Observability 래핑 Pipeline 클래스 |
...
| AdapterPipelineGenerator | `[GeneratePipeline]` | Functorium.SourceGenerators |
