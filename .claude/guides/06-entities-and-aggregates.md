...
// EF Core Configuration 및 Mapper 매핑은 12-ports-and-adapters.md 참조
```
...
> Navigation Property가 필요한 경우는 [Port와 Adapter 가이드](./12-ports-and-adapters.md)를 참조하세요.
...
- [ ] EF Core 통합은 [Port와 Adapter 가이드](./12-ports-and-adapters.md) 참조
...
- [Port와 Adapter 가이드](./12-ports-and-adapters.md) - EF Core 통합, Persistence Model 매핑
