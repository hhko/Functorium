...
| [10-usecases-and-cqrs.md](./10-usecases-and-cqrs.md) | Usecase 구현 | CQRS 패턴, Apply 병합 |
| [11-ports-and-adapters.md](./11-ports-and-adapters.md) | Adapter 구현 | Port 정의, Adapter 구현, Pipeline |
| [09-domain-services.md](./09-domain-services.md) | 도메인 서비스 | IDomainService, 교차 Aggregate 로직, Usecase 통합 |
| [12-unit-testing.md](./12-unit-testing.md) | 단위 테스트 | 테스트 규칙, 네이밍, 체크리스트 |
| [13-testing-library.md](./13-testing-library.md) | 테스트 라이브러리 | 로그/아키텍처/소스생성기/Job 테스트 |
