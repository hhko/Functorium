...
> **상세 내용은 [에러 시스템 가이드](./08-error-system.md)를 참조하세요.**
...
> **참고**: Entity도 동일한 Create/Validate 분리 패턴을 따릅니다. 자세한 내용은 [Entity 구현 가이드 - 구현 패턴](./06-entities-and-aggregates.md#구현-패턴)을 참고하세요.
