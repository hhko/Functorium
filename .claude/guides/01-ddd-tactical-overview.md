...
- **배치되는 빌딩블록**: Value Object, Entity, Aggregate Root, Domain Event, Domain Error, Repository Interface
- **의존성**: 없음 (가장 안쪽 레이어)
...
| 문서 | 설명 | 주요 내용 |
|------|------|----------|
| [02-value-objects.md](./02-value-objects.md) | 값 객체 구현 | 기반 클래스, 검증 시스템, 구현 패턴, 실전 예제 |
