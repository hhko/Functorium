...
| `Docs.Site/.../tutorials/<name>/<PascalName>.slnx` | 튜토리얼별 개별 솔루션 | 문서 내 실습 코드 빌드 |
| `Docs.Site/.../samples/<name>/<PascalName>.slnx` | 예제별 개별 솔루션 | 문서 내 실습 코드 빌드 |
| `Docs.Site/.../quickstart/Quickstart.slnx` | 퀵스타트 솔루션 | 문서 내 실습 코드 빌드 |
...
| `Build-SetAsSetupProject.ps1` | VSCode launch.json/tasks.json에 프로젝트 실행 설정 추가 |
| `Build-VerifyAccept.ps1` | Verify.Xunit 스냅샷 테스트 승인: `./Build-VerifyAccept.ps1` |
