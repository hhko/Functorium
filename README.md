...
// 검증 실패 → DomainError: "DomainErrors.Email.Empty", "DomainErrors.Email.InvalidFormat" 등
...
public sealed class GetCustomerByIdQuery
{
    ...
    public sealed class Usecase(ICustomerDetailQuery adapter)
        : IQueryUsecase<Request, Response>
    {
        ...
        {
            FinT<IO, Response> usecase =
                from dto in adapter.GetById(CustomerId.Create(request.CustomerId))
