...
namespace Cqrs05EndpointLayered.Adapters.Infrastructure.Abstractions.Registrations;
...
public static class AdapterInfrastructureRegistration
{
    public static IServiceCollection RegisterAdapterInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddValidatorsFromAssembly(Cqrs05EndpointLayered.Applications.AssemblyReference.Assembly);
