...
using HexagonalMapping.Strategy3.ExternalConfig.Application.Port.In;
using HexagonalMapping.Strategy3.ExternalConfig.Application.Port.Out;

namespace HexagonalMapping.Strategy3.ExternalConfig.Application.Service;
