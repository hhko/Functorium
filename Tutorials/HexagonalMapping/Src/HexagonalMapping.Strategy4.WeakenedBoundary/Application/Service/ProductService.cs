using HexagonalMapping.Strategy4.WeakenedBoundary.Application.Port.In;
using HexagonalMapping.Strategy4.WeakenedBoundary.Application.Port.Out;
using HexagonalMapping.Strategy4.WeakenedBoundary.Model;

namespace HexagonalMapping.Strategy4.WeakenedBoundary.Application.Service;
