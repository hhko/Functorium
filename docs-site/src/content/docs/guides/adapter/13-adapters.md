...
이 문서는 Port 인터페이스의 구현체인 Adapter를 유형별로 구현하는 가이드입니다. Port 정의는 [12-ports.md](./12-ports.md), Pipeline 생성과 DI 등록은 [14a-adapter-pipeline-di.md](./14a-adapter-pipeline-di.md)을 참조하세요.
...
| [14b-adapter-testing.md](./14b-adapter-testing.md) | Adapter 단위 테스트, E2E Walkthrough |
