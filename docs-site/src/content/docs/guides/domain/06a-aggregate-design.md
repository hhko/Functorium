...
이 문서는 DDD 전술적 설계 관점에서 Aggregate 설계 원칙과 개념을 다룹니다. Entity/Aggregate 구현 방법은 [06b-entity-aggregate-core.md](./06b-entity-aggregate-core.md)를 참조하세요.
...
**연결 방식:**
- Inventory는 `ProductId`로 Product를 **ID 참조** (객체 참조 아님, [§Cross-Aggregate 관계](./06c-entity-aggregate-advanced.md#cross-aggregate-관계))
...
- [Entity/Aggregate 핵심 패턴 (HOW)](./06b-entity-aggregate-core.md)
- [Entity/Aggregate 고급 패턴](./06c-entity-aggregate-advanced.md)
