...
/// <summary>
/// SourceGenerator로 생성된 Adapter Pipeline의 로그 필드 검증 테스트.
/// 런타임에서 실제 Pipeline을 실행하고 로그 출력을 스냅샷으로 검증합니다.
/// </summary>
/// <remarks>
/// <para>
/// 이 테스트는 생성된 Pipeline 코드의 로깅 필드 구조가 실수로 변경되는 것을 방지합니다.
/// </para>
/// <para>
/// 로그 필드 구조 비교표:
/// </para>
...
public sealed class AdapterLoggingPipelineStructureTests : IDisposable
{
    private readonly ActivitySource _activitySource;
    private readonly IMeterFactory _meterFactory;
    private readonly IOptions<OpenTelemetryOptions> _openTelemetryOptions;

    public AdapterLoggingPipelineStructureTests()
    {
    ...
    public async Task Request_Should_Log_Expected_Fields()
    {
        ...
        var logger = context.CreateLogger<TestObservabilityAdapterPipeline>();
