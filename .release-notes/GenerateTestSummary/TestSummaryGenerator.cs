...
{
    public static string CreateCombinedTestSummaryReport(IReadOnlyList<string> trxFilePaths)
    {
        ...
        overallTableBuilder.Append(GenerateTopTestsPerRun(trxFilePaths));
    ...
    private static string GenerateTopTestsPerRun(IReadOnlyList<string> trxFilePaths)
    {
