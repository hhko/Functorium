...
3. **섹션 채우기**
   ...
   - 각 기능에 대해 코드 예제과 "Why this matters (왜 중요한가):" 섹션 작성

4. **API 검증**
   - 모든 코드 예제을 Uber 파일에서 검증
...
**정확한 코드 예제 작성에 사용** - 이 파일은 현재 빌드의 **모든 API**를 포함합니다:
...
- **완전한 예시 포함**: 가능하면 전체, 작동하는 코드 예제 표시
