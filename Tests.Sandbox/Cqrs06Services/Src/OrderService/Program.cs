...
// 소스 생성기가 [GenerateObservablePort] 애트리뷰트를 감지하여 InMemoryOrderRepositoryObservable 클래스를 자동 생성
...
// 소스 생성기가 [GenerateObservablePort] 애트리뷰트를 감지하여 RabbitMqInventoryMessagingObservable 클래스를 자동 생성
