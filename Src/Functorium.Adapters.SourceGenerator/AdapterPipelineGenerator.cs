        ...
        AttachDebugger: false)  // ⚠️ 디버깅 필요 시 true로 변경 (자세한 내용: DEBUGGING_SOURCE_GENERATOR.md 참조)
{
    ...
    private static string GeneratePipelineClassSource(PipelineClassInfo classInfo, StringBuilder sb)
    {
        sb.Append(Header)
            ...
            .AppendLine("using Functorium.Applications.Observabilities.Context;")
            .AppendLine("using Functorium.Applications.Observabilities.Metrics;")
            .AppendLine("using Functorium.Applications.Observabilities.Spans;")
            .AppendLine()
    ...
    private static void GenerateHelperMethods(StringBuilder sb, PipelineClassInfo classInfo)
    {
        sb.AppendLine("    private static global::LanguageExt.IO<A> FinTToIO<A>(global::LanguageExt.FinT<global::LanguageExt.IO, A> finT) =>")
            ...
            .AppendLine("                requestHandlerMethod);")
            .AppendLine()
            .AppendLine("            _metricRecorder.RecordRequest(")
            .AppendLine($"                this.GetRequestCategoryPascalCase(),")
            .AppendLine("                requestHandler,")
            .AppendLine("                requestHandlerMethod);")
            .AppendLine()
            ...
            .AppendLine("    {")
            .AppendLine($"        _metricRecorder.RecordResponseSuccess(this.GetRequestCategoryPascalCase(), RequestHandler, \"Method\", elapsed);")
            ...
            .AppendLine("    {")
            .AppendLine($"        _metricRecorder.RecordResponseFailure(this.GetRequestCategoryPascalCase(), RequestHandler, \"Method\", elapsed, error);")
