...
/// <summary>
/// LanguageExt 기반 단일 비교 가능한 값 객체를 위한 기본 클래스
/// 단일 IComparable 값을 래핑하는 값 객체의 공통 기능을 제공
/// </summary>
/// <typeparam name="T">래핑할 값의 타입 (IComparable을 구현해야 함)</typeparam>
[Serializable]
    ...
    where T : notnull, IComparable
{
    ...
    /// <summary>
    /// SimpleComparableValueObject 인스턴스를 생성하는 protected 생성자
    /// 직접 인스턴스 생성 방지
    /// </summary>
    ...
    /// <summary>
    /// SimpleComparableValueObject에서 T로의 명시적 변환
    /// </summary>
    /// <param name="valueObject">변환할 값 객체</param>
    public static explicit operator T(ComparableSimpleValueObject<T>? valueObject)
    {
        if (valueObject is null)
            throw new InvalidOperationException("Cannot convert null SimpleComparableValueObject to T");
    ...
    /// 동등성 연산자
    /// </summary>
    /// <param name="left">왼쪽 SimpleComparableValueObject</param>
    /// <param name="right">오른쪽 SimpleComparableValueObject</param>
    /// <returns>동등하면 true, 그렇지 않으면 false</returns>
