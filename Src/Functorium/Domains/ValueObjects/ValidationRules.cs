...
public static class ValidationRules
{
    ...
    /// <returns>검증 결과</returns>
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Validation<Error, T> NonNegative<TValueObject, T>(T value)
    ...
    /// <returns>검증 결과</returns>
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Validation<Error, T> Between<TValueObject, T>(T value, T min, T max)
        where T : notnull, INumber<T> =>
        value >= min && value <= max
            ? value
            : DomainError.For<TValueObject, T>(
    ...
    /// <returns>검증 결과</returns>
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Validation<Error, T> AtLeast<TValueObject, T>(T value, T min)
        where T : notnull, INumber<T> =>
        value >= min
            ? value
            : DomainError.For<TValueObject, T>(
    ...
    /// <returns>검증 결과</returns>
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Validation<Error, T> Must<TValueObject, T>(
        T value,
    ...
    /// <returns>검증 결과</returns>
    [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Validation<Error, string> ExactLength<TValueObject>(string value, int length) =>
        value.Length == length
            ? value
            : DomainError.For<TValueObject>(
