...
```json
{
  ...
  "error.type": "expected",
  "error.code": "Adapter.UsecaseValidationPipeline`2.PipelineValidation",
  "error.detail": "{\"ErrorKind\":\"ExpectedError`1\",\"NumericCode\":-1000,\"ErrorCode\":\"Adapter.UsecaseValidationPipeline`2.PipelineValidation\",\"Message\":\"Name: [DomainErrors.ProductName.Empty] ProductName cannot be empty. Current value: ''\"}",
  "log.logger": "Functorium.Adapters.Observabilities.Pipelines.UsecaseLoggingPipeline"
}
```
...
[20:40:37 WRN] application usecase.command TestErrorCommand.Handle responded failure in 0.0050 s with expected:TestErrors.TestErrorCommand.BusinessRuleViolation {"ErrorKind": "ExpectedError", "ErrorCode": "TestErrors.TestErrorCommand.BusinessRuleViolation", "NumericCode": -1000, "ErrorCurrentValue": "Business rule violation test", "Message": "Business rule violated: Business rule violation test"} {"EventId": {"Id": 1003, "Name": "application.response.warning"}, "SourceContext": "Functorium.Adapters.Observabilities.Pipelines.UsecaseLoggingPipeline", "RequestId": "0HNK77Q79FSRN:00000001", "RequestPath": "/api/test-error", "ConnectionId": "0HNK77Q79FSRN"}
```
...
```json
{
  ...
  "error.detail": "{\"ErrorKind\":\"ExpectedError\",\"ErrorCode\":\"TestErrors.TestErrorCommand.BusinessRuleViolation\",\"NumericCode\":-1000,\"ErrorCurrentValue\":\"Business rule violation test\",\"Message\":\"Business rule violated: Business rule violation test\"}",
  "log.logger": "Functorium.Adapters.Observabilities.Pipelines.UsecaseLoggingPipeline"
}
```
...
```json
{
  ...
  "error.detail": "{\"ErrorKind\":\"ExceptionalError\",\"ErrorCode\":\"TestErrors.TestErrorCommand.SystemFailure\",\"NumericCode\":-2146233079,\"Message\":\"System failure: System error test\",\"ExceptionDetails\":{\"TargetSite\":null,\"Message\":\"System failure: System error test\",\"Data\":[],\"InnerException\":null,\"HelpLink\":null,\"Source\":null,\"HResult\":-2146233079,\"StackTrace\":null}}",
  "log.logger": "Functorium.Adapters.Observabilities.Pipelines.UsecaseLoggingPipeline"
}
```
