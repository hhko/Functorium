...
public class CustomerOrderSummaryQueryInMemory
    : InMemoryQueryBase<Customer, CustomerOrderSummaryDto>, ICustomerOrderSummaryQuery
{
    ...
    {
        var ordersByCustomer = OrderRepositoryInMemory.Orders.Values
            .GroupBy(o => o.CustomerId)
            .ToDictionary(g => g.Key, g => g.ToList());

        return CustomerRepositoryInMemory.Customers.Values
