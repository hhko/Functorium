...
public class DapperOrderWithProductsQuery : IOrderWithProductsQuery
{
    ...
    public DapperOrderWithProductsQuery(IDbConnection connection) => _connection = connection;
    ...
    public virtual FinT<IO, OrderWithProductsDto> GetById(OrderId id)
    {
        return IO.liftAsync(async () =>
        {
            ...
            if (rowList.Count == 0)
                return AdapterError.For<DapperOrderWithProductsQuery>(
